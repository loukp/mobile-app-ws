...
//Controller responsible for operations that have to do with users
// http://localhost:8080/users

@RestController // receive http requests when they are sent and match URL path
@RequestMapping("users") // requests sent to certain URL, this URL contains paths
